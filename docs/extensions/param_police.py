...
def gcell_log_param_types(self, fields, field_role="param", type_role="type"):
    for _name, _type, _desc in fields:
        if not _type or not self._obj.__module__.startswith("gcell"):
            continue
...
def setup(app: Sphinx):
    NumpyDocstring._format_docutils_params = gcell_log_param_types
